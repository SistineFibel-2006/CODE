...
vector<int> cum = {0,31,31+29,31+29+31,31+29+31+30,31+29+31+30+31,
                       31+29+31+30+31+30,31+29+31+30+31+30+31,
                       31+29+31+30+31+30+31+31,31+29+31+30+31+30+31+31+30,
                       31+29+31+30+31+30+31+31+30+31,31+29+31+30+31+30+31+31+30+31+30,366};
...
/**/    int k, l, r; cin >> k >> l >> r;
        ...
        Fd(d, 1, 366) {
            ...
            int c = 0;
            Fd(i, l, r){
                if(m == 2 && da == 29 && !isLeap(i)) continue;
                int w = weekday(i, m, da);
                if(w == 0 || w == 6) continue;
                c ++;
            }
            cnt[d] = c;
