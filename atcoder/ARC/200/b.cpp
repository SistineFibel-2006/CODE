...
/**/I(a); I(b); I(c);
  	...
  	if(c < b) return(puts("No"));
  	if(c > a + b) return(puts("No"));
  	puts("Yes");
  	string x1 = "" , x2 = "" ;

  	if(c == a + b) {x1 = string(a, '9'); x2 = "8" + string(b-1, '0');}
  	else {x2 = "1" + string(b-1, '0'); x1 = string(c-b+1, '9') + string(a+b-c-1, '0');}
  	if(sw) swap(x1, x2);
  	cout << x1 << ' ' << x2 << el;
